 ...
 * @author tamara
 */
public class UcitajListuLokacijaSO extends OpstaSistemskaOperacija{
     @Override
    ...
    protected ServerskiOdgovor izvrsiKonkretnuOperaciju(Object object) throws Exception {
         try{
            ...
            List<IOpstiDomenskiObjekat> lista=DBBroker.getInstance().select((Lokacija)object);//insert ako hocemo da se cuva
