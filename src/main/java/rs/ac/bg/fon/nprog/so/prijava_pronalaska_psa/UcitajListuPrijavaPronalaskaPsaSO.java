 ...
 * @author tamara
 */
public class UcitajListuPrijavaPronalaskaPsaSO extends OpstaSistemskaOperacija{
     @Override
    ...
    protected ServerskiOdgovor izvrsiKonkretnuOperaciju(Object object) throws Exception {
        ...
        return so;
            ...
            Logger.getLogger(UcitajListuPrijavaPronalaskaPsaSO.class.getName()).log(Level.SEVERE,null,ex);
            throw new Exception("");
        }
    }
}
