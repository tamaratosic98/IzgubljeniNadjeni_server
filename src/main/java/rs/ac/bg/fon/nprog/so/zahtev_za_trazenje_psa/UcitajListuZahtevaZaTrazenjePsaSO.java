 ...
 * @author tamara
 */
public class UcitajListuZahtevaZaTrazenjePsaSO extends OpstaSistemskaOperacija {
    @Override
    ...
    protected ServerskiOdgovor izvrsiKonkretnuOperaciju(Object object) throws Exception {
        ...
        return so;
            ...
            Logger.getLogger(UcitajListuZahtevaZaTrazenjePsaSO.class.getName()).log(Level.SEVERE,null,ex);
            throw new Exception("");
        }
